...
func InitMapReduce(nmap int, nreduce int,
	...
	mr.InitMapReduceImpl(nmap, nreduce, file, master)
...
func MapName(fileName string, MapJob int) string {
	return OutputDir + "mrtmp." + fileName + "-" + strconv.Itoa(MapJob)
}
...
func MergeName(fileName string, ReduceJob int) string {
	return OutputDir + "mrtmp." + fileName + "-res-" + strconv.Itoa(ReduceJob)
}
...
func (mr *MapReduce) Merge() {
	...
	file, err := os.Create(OutputDir + "mrtmp." + mr.file)
	if err != nil {
...
func (mr *MapReduce) CleanupFiles() {
	...
	RemoveFile(OutputDir + "mrtmp." + mr.file)
}
